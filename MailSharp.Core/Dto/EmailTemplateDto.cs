namespace MailSharp.Core.Dto
{
    public class EmailTemplateDto
    {
        ...
        public required string Name { get; set; }        // Nome do template (ex: "Promoção Janeiro")
        public required string Subject { get; set; }     // Assunto do e-mail
        public required string Body { get; set; }        // Corpo do e-mail (pode ser HTML)
